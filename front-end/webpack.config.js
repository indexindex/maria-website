...
module.exports = {
    ...
    output: {
        filename: './js/[name].[contenthash].bundle.js', // bundled file (name refers to entry file names)
    ...
    plugins: [
        ...
        new MiniCssExtractPlugin({
            filename: './css/[name].[contenthash].css', // bundled css file (name refers to entry file names)
            // filename also contains pattern [contenthash] which can be used instead of bundle to generate hashed file names
        })
    ],
